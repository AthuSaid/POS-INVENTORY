	...
	<body>
		...
		<div>
			<div class="row">
				...
				<div class="col-sm-9"><font color="purple">
                ...
                <div align="center"> <?php echo $mesg; ?> </div>
					<div class="tab-pane active" id="tabs1-pane1">
						<form class="form-horizontal" role="form" method="post" action="inventory.php" enctype="multipart/form-data" name="test">
								...
								<div class="form-group">
								<div class="col-sm-6">
									<input type="submit" class="btn btn-success btn-large" value="Submit" onsubmit="return validateField()" name="submit" id="submit"/>
								</div>
								</div>
