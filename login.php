	...
	<body>
		...
		<div>
			<div class="row">
                ...
                <div align="center"><font color="silver"> <?php if($errmsg!=""){ echo $errmsg; } else {echo $mesg;} ?> </div>
					<div class="tab-pane active" id="tabs1-pane1">
						<form class="form-horizontal" role="form" method="post" action="login.php"  name="test">
								...
								<div class="form-group">
								<input type="submit" class="btn btn-success btn-large" value="Sign In" onsubmit="return validateField()" name="submit" id="submit"/>
								<div class="col-sm-6">
