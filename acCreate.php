									<input type="submit" class="btn btn-success btn-large" value="Register" onsubmit="return validateField()" name="submit" id="submit"/>
	...
	<body>
		...
		<div>
			<div class="row">
				...
				<div class="col-sm-9"><font color="silver">
